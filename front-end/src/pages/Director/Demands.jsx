...
const DirectorDemands = () => {
  ...
  const processedDemands = demands.filter(d => ['approved_by_director', 'rejected_by_director'].includes(d.status));
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Typography variant="h4" gutterBottom>
        Gestion des demandes - Directeur
      </Typography>
...
export default DirectorDemands;
